...
const double Accel_Corrector_2g = 16384.0;
const double Accel_Corrector_4g = 8192.0;
const double Accel_Corrector_8g = 4096.0;
const double Accel_Corrector_16g = 2048.0;

const double Gyro_Corrector_250deg = 131.0;
const double Gyro_Corrector_500deg = 65.5;
const double Gyro_Corrector_1000deg = 32.8;
const double Gyro_Corrector_2000deg = 16.4;
...
void MPU6050_Read_Gyro(I2C_HandleTypeDef *I2Cx, MPU6050_t *DataStruct)
{
    ...
    DataStruct->Gx = DataStruct->Gyro_X_RAW / Gyro_Corrector_250deg;
    DataStruct->Gy = DataStruct->Gyro_Y_RAW / Gyro_Corrector_250deg;
    DataStruct->Gz = DataStruct->Gyro_Z_RAW / Gyro_Corrector_250deg;
}
...
double Kalman_getAngle(Kalman_t *Kalman, double newAngle, double newRate, double dt)
{
    ...
    Kalman->P[0][0] += dt * (dt * Kalman->P[1][1] - Kalman->P[0][1] - Kalman->P[1][0] + Kalman->QAngle);
    Kalman->P[0][1] -= dt * Kalman->P[1][1];
    Kalman->P[1][0] -= dt * Kalman->P[1][1];
    Kalman->P[1][1] += Kalman->QBias * dt;

    double S = Kalman->P[0][0] + Kalman->RMeasure;
    double K[2];
    K[0] = Kalman->P[0][0] / S;
    K[1] = Kalman->P[1][0] / S;
