...
void SPI2_Inits(void)
{
	...
	SPI2handle.SPIConfig.SPI_ClkSpeed= SPI_CLK_SPEED_DIV2;
...
void Slave_GPIO_InterruptPinInit(void)
{
	...
	spiIntPin.GPIO_PinConfig.GPIO_PinNumber = GPIO_PIN_NUM_6;
...
int main(void)
{
	...
	*/
	...
	while(1){
		...
		GPIO_IRQInterruptConfig(IRQ_NO_EXTI4_15,DISABLE);
