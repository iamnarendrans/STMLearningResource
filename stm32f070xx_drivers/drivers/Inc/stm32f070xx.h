...
typedef struct
{
	...
	__vo uint32_t TIMEOUTR;		/*! I2C Time out Register 					Address offset: 0x14*/
	__vo uint32_t ISR;			/*! I2C Interrupt & Status Register 		Address offset: 0x18*/
	__vo uint32_t ICR;			/*! I2C Interrupt clear Register 			Address offset: 0x1C*/
	__vo uint32_t PECR;			/*! I2C Packet Error Check Register 		Address offset: 0x20*/
	__vo uint32_t RXDR;			/*! I2C Rx Data Register 					Address offset: 0x24*/
	__vo uint32_t TXDR;			/*! I2C Tx Data Register 					Address offset: 0x28*/
...
#include "stm32f70xx_i2c_driver.h"
